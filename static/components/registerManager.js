    ...
    template: `
      <div :style="containerStyle" style="margin-top:-30px">
        <div :style="formStyle" class="signup-form p-4">
          <h2 class="mb-4" style="text-align:center;color:green">Manager Sign Up</h2>
          <form @submit.prevent="register">
            <div class="mb-3">
              <label for="managerName" class="form-label">Manager Name</label>
              <input type="text" v-model="credentials.username" id="managerName" class="form-control" placeholder="Enter manager's name" required/>
            </div>
            <div class="mb-3">
          ...
          <p class="mt-3">
            Want to Sign Up as Customer? <router-link to="/register">Customer Sign Up</router-link>
          </p>
        </div>
      </div>
    `,
