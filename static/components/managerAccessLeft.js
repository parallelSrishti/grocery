import managerAddProducts from "./managerAddProducts.js";
...
export default{
  ...
  template:`
  <div>
    <div v-if="!creatingCategory && !successMessage && !creatingProduct" style="margin-left: 97px; margin-top: 30px">
    ...
    <div v-if="!creatingCategory && !successMessage" style=" margin-top: 30px">
